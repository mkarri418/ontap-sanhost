---
sidebar: sidebar
permalink: hu_suse_15 SP1SP1.html
...
`cat/sys/class/fc_host/host*/device/rport*/fc_remote_ports/rport*/port_state` | link:https://bugzilla.suse.com/show_bug.cgi?id=1139137[1139137^]
|===
