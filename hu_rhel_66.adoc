...
= Using Red Hat Enterprise Linux 6.6 with ONTAP
:toc: macro
:hardbreaks:
:toclevels: 1
:nofooter:
...
The RHEL 6.6 OS is compiled to recognize ONTAP LUNs and automatically set all configuration parameters correctly.
