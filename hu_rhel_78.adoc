...
= Using Red Hat Enterprise Linux 7.8 with ONTAP
:toc: macro
:hardbreaks:
:toclevels: 1
:nofooter:
...
The RHEL 7.8 OS is compiled to recognize ONTAP LUNs and automatically set all configuration parameters correctly.
