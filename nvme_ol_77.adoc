...
.	On the OL 7.7 host, check the hostnqn string at `/etc/nvme/hostnqn` and verify that it matches    the hostnqn string for the corresponding subsystem on the ONTAP array.
+
----
