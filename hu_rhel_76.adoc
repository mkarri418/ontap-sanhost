...
For Red Hat Enterprise Linux (RHEL) 7.6 the /etc/multipath.conf file must exist, but you do not need to make specific changes to the file. RHEL 7.6 is compiled with all settings required to recognize and correctly manage ONTAP LUNs.
