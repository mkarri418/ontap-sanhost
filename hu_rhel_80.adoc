...
= Using Red Hat Enterprise Linux 8.0 with ONTAP
:toc: macro
:hardbreaks:
:toclevels: 1
:nofooter:
...
The RHEL 8.0 OS is compiled to recognize ONTAP LUNs and automatically set all configuration parameters correctly.
