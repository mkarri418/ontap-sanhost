...
* By default, round-robin load balancing is not enabled. You must write a udev rule to enable this functionality. Steps are provided in the section on Enabling NVMe/FC on OL 8.1.
...
"ONTAPdevices" : [
   {
       "Device" : "/dev/nvme0n1",
       "Vserver" : "vs_141_nvme_test",
       "Namespace_Path" : "/vol/vol_test2/ns_test2",
       "NSID" : 2,
       "UUID" : "e6a2dde1-0bb0-40ac-9c3b-409c42c390e1",
      "Size" : "107.37GB",
       "LBA_Data_Size" : 4096,
       "Namespace_Size" : 26214400
   },
   {
        "Device" : "/dev/nvme0n2",
        "Vserver" : "vs_141_nvme_test",
        "Namespace_Path" : "/vol/vol_test3/ns_test3",
        "NSID" : 3,
        "UUID" : "9844aa67-e044-4f7f-86b5-cb4e10a0b8b8",
        "Size" : "107.37GB",
        "LBA_Data_Size" : 4096,
        "Namespace_Size" : 26214400
    }
